...
Partial Class Form2
    ...
    Private Sub InitializeComponent()
        ...
        Panel1.BackgroundImage = My.Resources.Resources.Kaizen_COmmunity
        ...
        lblAlamat.Location = New Point(441, 409)
        lblAlamat.Name = "lblAlamat"
        lblAlamat.Size = New Size(149, 20)
        lblAlamat.TabIndex = 12
        lblAlamat.Text = "#INI PLACEHOLDER#"
        ' 
        ' Label6
        ' 
        Label6.AutoSize = True
        Label6.Font = New Font("Sitka Small", 11.249999F, FontStyle.Bold)
        ...
        lblHobi.Location = New Point(441, 362)
        lblHobi.Name = "lblHobi"
        lblHobi.Size = New Size(149, 20)
        lblHobi.TabIndex = 9
        lblHobi.Text = "#INI PLACEHOLDER#"
        ' 
        ' lblJK
        ' 
        lblJK.AutoSize = True
        ...
        lblJK.Location = New Point(441, 310)
        lblJK.Name = "lblJK"
        lblJK.Size = New Size(149, 20)
        lblJK.TabIndex = 8
        lblJK.Text = "#INI PLACEHOLDER#"
        ' 
        ' lblTLahir
        ' 
        ...
        lblTLahir.Location = New Point(441, 256)
        lblTLahir.Name = "lblTLahir"
        lblTLahir.Size = New Size(149, 20)
        lblTLahir.TabIndex = 7
        lblTLahir.Text = "#INI PLACEHOLDER#"
        ' 
        ' lblUmur
        ' 
        ...
        lblUmur.Location = New Point(441, 204)
        lblUmur.Name = "lblUmur"
        lblUmur.Size = New Size(149, 20)
        lblUmur.TabIndex = 6
        lblUmur.Text = "#INI PLACEHOLDER#"
        ' 
        ' lblNama
        ' 
        ...
        lblNama.Location = New Point(441, 158)
        lblNama.Name = "lblNama"
        lblNama.Size = New Size(149, 20)
        lblNama.TabIndex = 5
        lblNama.Text = "#INI PLACEHOLDER#"
        ' 
        ' Label5
        ' 
        Label5.AutoSize = True
        Label5.Font = New Font("Sitka Small", 11.249999F, FontStyle.Bold)
        ...
        Label4.Font = New Font("Sitka Small", 11.249999F, FontStyle.Bold)
        ...
        Label2.Font = New Font("Sitka Small", 11.249999F, FontStyle.Bold)
        ...
        Label1.Font = New Font("Sitka Small", 11.249999F, FontStyle.Bold)
